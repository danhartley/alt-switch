...
var boundNextItem = function boundNextItem(data) {
  return _storeRepo.store.dispatch(nextItemAction(data, { delay: 1000 }));
};
...
},{"../store/store-repo.js":3,"./learn-types.js":12}],25:[function(require,module,exports) {
'use strict';
...
},{"../learn-dom.js":21,"../../store/store-repo.js":3,"../learn-actions.js":5,"../learn-types.js":12,"../../utils/utils.js":4}],23:[function(require,module,exports) {
'use strict';
...
},{"../learn-dom.js":21,"../../store/store-repo.js":3}],22:[function(require,module,exports) {
'use strict';
...
},{"../learn-dom.js":21,"../../store/store-repo.js":3,"./fails.js":23}],26:[function(require,module,exports) {
'use strict';
...
},{"../learn-dom.js":21,"../../store/store-repo.js":3,"../learn-types.js":12}],27:[function(require,module,exports) {
'use strict';
...
},{"../learn-dom.js":21,"../../store/store-repo.js":3,"../../utils/utils.js":4,"../learn-actions.js":5,"../learn-types.js":12}],28:[function(require,module,exports) {
'use strict';
...
var renderSpecimen = exports.renderSpecimen = function renderSpecimen() {
    ...
    if (type === _learnTypes.types.NEXT_ITEM) {
        ...
        var unsubscribe = _storeRepo.store.subscribe(renderSpecimen);
...
},{"../../utils/utils.js":4,"../learn-dom.js":21,"../../store/store-repo.js":3,"../learn-types.js":12}],20:[function(require,module,exports) {
'use strict';
...
// };
},{"./learn-types.js":12,"./learn-dom.js":21,"./screens/species.js":25,"./screens/passes.js":22,"./screens/fails.js":23,"./screens/score.js":26,"./screens/text-entry.js":27,"./screens/specimen.js":28}],13:[function(require,module,exports) {
'use strict';
...
//     switch(action.type) {
//         case types.CHANGE_STRATEGY_AND_NEXT_ITEM:
//             store.dispatch({ type: types.CHANGE_STRATEGY, data: action.data.strategy });
//             store.dispatch({ type: types.NEXT_ITEM, data: action.data.nextItem });
//         break;
//         default:
//             return state;
//     }
// };
},{"../utils/utils.js":4,"./learn-types.js":12,"./learn-strategy.js":20,"../store/store-repo.js":3}],14:[function(require,module,exports) {
"use strict";
...
var store = exports.store = createStore(reducer, applyMiddleware(_timeoutScheduler.timeoutScheduler, _logger.logger)
// window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__()
);
},{"../api/eol-tejo.js":10,"../api/eol-trees.js":11,"../utils/utils.js":4,"../learn/learn-types.js":12,"../learn/learn-reducers.js":13,"../learn/middleware/timeoutScheduler.js":14,"../learn/middleware/logger.js":15}],6:[function(require,module,exports) {
'use strict';
...
var renderNext = exports.renderNext = function renderNext() {
    ...
    var unsubscribe = _storeRepo.store.subscribe(renderNext);
    ...
    if (type === _learnTypes.types.MARK_ANSWER) {
        ...
        if (items.length === score.total) {
            ...
            _learnActions.actions.boundChangeStrategy(_strategy);
...
},{"../../utils/utils.js":4,"../learn-types.js":12,"../learn-actions.js":5,"../../store/store-repo.js":3,"../screens/passes.js":22,"../screens/fails.js":23,"../learn-strategy.js":20,"../learn-dom.js":21}],1:[function(require,module,exports) {
'use strict';
...
(0, _nextScreen.renderNext)();
_learnActions.actions.boundNextItem(_utils.utils.nextItem(items, item.index));
},{"../utils/utils.js":4,"../store/store-repo.js":3,"./learn-actions.js":5,"./screens/next-screen.js":6}],33:[function(require,module,exports) {
