...
var MARK_ANSWER = '[logic] Check user answer and update running score';
var NEW_SCREEN = '[ui] Render new screens';
...
var renderSpecies = exports.renderSpecies = function renderSpecies() {
    ...
    rptrSpecies.innerHTML = answers.map(function (species) {
        var vernacularNames = species.names.filter(function (name) {
...
},{"../learn-dom.js":8,"../../store/store-repo.js":7,"../learn-actions.js":6,"../../utils/utils.js":5}],10:[function(require,module,exports) {
'use strict';
...
},{"../learn-dom.js":8,"../../store/store-repo.js":7}],9:[function(require,module,exports) {
'use strict';
...
},{"../learn-dom.js":8,"../../store/store-repo.js":7,"./fails.js":10}],30:[function(require,module,exports) {
'use strict';
...
},{"../learn-dom.js":8,"../../store/store-repo.js":7}],31:[function(require,module,exports) {
'use strict';
...
},{"../learn-dom.js":8,"../../store/store-repo.js":7,"../../utils/utils.js":5,"../learn-actions.js":6}],32:[function(require,module,exports) {
'use strict';
...
var renderSpecimen = exports.renderSpecimen = function renderSpecimen() {
    ...
    var handleTabPress = function handleTabPress(event) {
        if (event.key === 'Tab') {
    ...
    var renderImages = function renderImages(specimenImages) {
        ...
        return function () {
            var displayImages = images.splice(0, 4);
...
},{"../../utils/utils.js":5,"../learn-dom.js":8,"../../store/store-repo.js":7}],27:[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.learnStrategies = undefined;
...
var learnStrategies = exports.learnStrategies = [{
  id: 1,
  active: false,
  elements: [{
    name: 'specimen',
...
},{"./learn-dom.js":8,"./screens/species.js":29,"./screens/passes.js":9,"./screens/fails.js":10,"./screens/score.js":30,"./screens/text-entry.js":31,"./screens/specimen.js":32}],28:[function(require,module,exports) {
'use strict';
...
var _eolTejo = require('./eol-tejo.js');

var binomials = _eolTejo.tejoSpecies.map(function (item) {
...
var species = _utils.utils.shuffleArray(binomials);

var api = exports.api = {
        species: species
};
},{"../utils/utils.js":5,"./eol-tejo.js":17}],18:[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.randomiser = exports.strategies = exports.strategy = exports.items = exports.item = exports.score = undefined;
...
var items = exports.items = function items() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _api.api.species;
    var action = arguments[1];
...
var numberOfAlternateAnswers = _api.api.species.length > 5 ? 5 : _api.api.species.length;
_api.api.species.forEach(function (correctAnswer) {
    var answers = {};
    var alternateAnswers = _api.api.species.filter(function (s) {
...
var initStrategies = _utils.utils.randomiseSelection(_learnStrategy.learnStrategies, _api.api.species.length).map(function (strategy) {
...
var strategy = exports.strategy = function strategy() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialRandomState.strategiesCollection.strategies[0];
    var action = arguments[1];
...
var strategies = exports.strategies = function strategies() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    var action = arguments[1];

    switch (action.type) {
        default:
            return _learnStrategy.learnStrategies;
    }
};
...
},{"../../utils/utils.js":5,"../learn-types.js":25,"../learn-strategy.js":27,"../../store/store-repo.js":7,"../../api/api.js":28}],19:[function(require,module,exports) {
"use strict";
...
var _learnReducers = require('../learn/reducers/learn-reducers.js');
...
var reducer = combineReducers({
    strategies: _learnReducers.strategies,
...
},{"../api/eol-tejo.js":17,"../utils/utils.js":5,"../learn/reducers/learn-reducers.js":18,"../learn/middleware/timeoutScheduler.js":19,"../learn/middleware/logger.js":20}],6:[function(require,module,exports) {
'use strict';
...
},{"../store/store-repo.js":7,"./learn-types.js":25}],3:[function(require,module,exports) {
'use strict';
...
_learnActions.actions.boundNewScreen(newScreen);
},{"../../utils/utils.js":5,"../learn-actions.js":6,"../../store/store-repo.js":7,"../screens/passes.js":9,"../screens/fails.js":10,"../learn-dom.js":8}],1:[function(require,module,exports) {
'use strict';

var _nextScreen = require('./screens/next-screen.js');
},{"./screens/next-screen.js":3}],33:[function(require,module,exports) {
